...
public class VirtualEJB implements Serializable{
	...
	public PlaylistEntity update(PlaylistEntity playList){
		//actualiza os dados da PlayList na BD e devolve a mesma PlayList j� da BD depois de actualizada
		return playList;
	}
	...
	public UserEntity update(UserEntity user){
		//actualiza os dados do utilizador na BD e devolve o mesmo utilizador j� da BD depois de actualizado
		return user;
	}
...
//		String tipomusica
		...
		for(i=0;i<10;i++){
			MusicEntity m=new MusicEntity("Track"+i, "The Shins", "Port of Morrow", "2015", users.get(0), "path", "2015/05/28", "Gen�rico");
			musics.add(m);
		}

		for(i=0;i<10;i++){
			MusicEntity m=new MusicEntity("Track"+i, "The Shins", "Oh The Inverted World", "2015", users.get(0), "path", "2015/05/28", "Gen�rico");
			musics.add(m);
		}	

		for(i=0;i<10;i++){
			MusicEntity m=new MusicEntity("Track"+i, "Coldplay", "Parachutes", "2015", users.get(1), "path", "2015/05/28", "Gen�rico");
			musics.add(m);
		}	

		for(i=0;i<10;i++){
			MusicEntity m=new MusicEntity("Track"+i, "Coldplay", "A Rush Of Blood To The Head", "2015", users.get(1), "path", "2015/05/28", "Gen�rico");
			musics.add(m);
		}	
	...
	private void generateUsers() {
		this.date = new Date();
		UserEntity user1=new UserEntity("Carlos", "123", "caje08@gmail.com", "1969/09/19");
		UserEntity user2=new UserEntity("Duarte", "123", "duarte.m.a.goncalves@gmail.com", "1985/01/15");
