...
import dei.uc.pt.ar.paj.PlaylistFacade;
...
//		return userplaylistsdisplay;
//		return playlistEJB.getPlaylists();
		return playlistEJB.findOrdered(order, usersession.getLoggedUser());
	}
...
//		return this.ejb.getMusics();
	...
	public void saveUserChanges() {
		...
		userFacade.updateUser(activeUser, activeUser.getName(),
